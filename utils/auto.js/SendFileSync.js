...
var projectName = 'send_qrcodeImage'

var newImage = '';

var stateStorage = storages.create('send_imageVersion');
// events.on("exit", function(){
//     stateStorage.put("send_currentImage", '');
// });
...
function runProject() {
    ...
    console.log(filePath)
    const currentImage = stateStorage.get("send_currentImage", '') 
    console.log('current ', currentImage, 'newImage', newImage)
    if (currentImage !== newImage) {
      stateStorage.put("send_currentImage", newImage);
